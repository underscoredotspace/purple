...
const RedDead: React.FC = () => {
    return (
        <>
            <div className="m-4">
                <p>
                    We are now roaming the beautiful lands of{" "}
                    <b>Red Dead Online</b>. We have made a couple of additions
                    to our server so we can help cowpokes with their adventures
                </p>
            </div>
            <LazyImage
            ...
            <div className="m-4">
                <p>
                    ...
                    created by Bob Ross, that allows you to locate different
                    types of collectibles, missions, herbs, animals, shops and
                    treasures.
                </p>
            </div>
            ...
            <div className="m-4">
                <p>
                    There&apos;s also activity roles for when you’re looking for
                    help, some cool{" "}
                ...
                <Card className="mb-4">
                    <SectionTitle type="h3">
                        {rdoAchievements.name}
                    </SectionTitle>
                    <p>{rdoAchievements.desc}</p>
                    <AchievementTable
                ...
                <p>
                    On top of that we are currently working on guides, curated
                    by our most experienced players.
                </p>
            </div>
            ...
            <Card className="mx-4 mt-4">
                ...
                <p>
                    ...
                    to access all of our guides, collect some achievement roles,
                    and some lovely <b>stew</b>
                </p>
            </Card>
        </>
    )
