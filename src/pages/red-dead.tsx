...
const RedDead: React.FC = () => (
    <>
        <p>
            We are now roaming the beautiful lands of <b>Red Dead Online</b>. We
            have made a couple of additions to our server so we can help
            cowpokes with their adventures
        </p>
        ...
        <p>
            There&apos;s also activity roles for when you’re looking for help,
            some cool{" "}
        ...
        <p>
            On top of that we are currently working on guides, curated by our
        ...
        <Card padding>
            ...
            <p>
                ...
                to access all of our guides, collect some achievement roles, and
                some lovely <b>stew</b>
            </p>
        </Card>
    </>
)
