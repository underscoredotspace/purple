const SocialCard: React.FC = () => (
  <>
    ...
    <meta
      ...
      content="An active and supportive PlayStation 5 and Xbox X|S Grand Theft Auto Online crew and gaming community"
    />
    <meta property="og:url" content="https://gpadcrew.com" />
    <meta name="og:image" content="https://i.gpadcrew.com/gta-style.png" />
